...
sub create_feature
{
	...
	while(<IN>)
	{
		...
		print("$DeepPM_dir/P0_prepare_features/gen_query_files.pl $option_file $work_dir/$id_tmp.fasta $work_dir\n\n");
		system("$DeepPM_dir/P0_prepare_features/gen_query_files.pl $option_file $work_dir/$id_tmp.fasta $work_dir");
		...
		chomp $cur_dir;
		chdir $work_dir;
		print("$DeepPM_dir/P0_prepare_features/hhsearch_align_prepare.pl $prosys_dir $new_hhsearch_dir $psipred_dir $work_dir/$id_tmp.fas $work_dir/$id_tmp.shhm");
		system("$DeepPM_dir/P0_prepare_features/hhsearch_align_prepare.pl $prosys_dir $new_hhsearch_dir $psipred_dir $work_dir/$id_tmp.fas $work_dir/$id_tmp.shhm");
		chdir $work_dir;
	}
	close IN;
