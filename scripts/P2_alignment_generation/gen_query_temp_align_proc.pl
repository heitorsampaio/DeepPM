...
#Date: 08/21/2005
###############################################################################
my $GLOBAL_PATH='/Users/heitorsampaio/Google_Drive/Projetos/Protein_DeepLearning/DeepPM/';
...
-d $spem_dir || die "can't find spem dir $spem_dir.\n";
...
sub create_feature
{
	...
	#print("$prosys_dir/script/fr_gen_align_all.pl $qopt $qfile $libfile $tfile $ofile\n");
	print("$GLOBAL_PATH/scripts/P2_alignment_generation/fr_gen_align_all.pl $qopt $qfile $libfile $tfile $ofile\n");
	system("$GLOBAL_PATH/scripts/P2_alignment_generation/fr_gen_align_all.pl $qopt $qfile $libfile $tfile $ofile");
