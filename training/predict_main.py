...
cmd1='python3 '+ GLOBAL_PATH + '/lib/DLS2F_predict_fea.py  '+ train_datafile + '  ' + modelfile+ '  ' + weightfile+ '  ' + feature_dir_global + '  ' +  pssm_dir_global + ' '   + resultdir + '  '+str(ktop_node)
print("Running ", cmd1,"\n\n")
os.system(cmd1)

cmd2='python3 '+ GLOBAL_PATH + '/lib/DLS2F_evaluate_SCOP.py  '+ train_datafile  + '  '+GLOBAL_PATH +'/datasets/D1_SimilarityReduction_dataset/fold_label_relation2.txt  '  + resultdir + '  ' + results_train
print("Running ", cmd2,"\n\n")
os.system(cmd2)
...
cmd1='python3 '+ GLOBAL_PATH + '/lib/DLS2F_predict_fea.py  '+ test_datafile + '  ' + modelfile+ '  ' + weightfile + '  ' +  feature_dir_global + '  ' +  pssm_dir_global + ' '   + resultdir + '   '+str(ktop_node)
print("Running ", cmd1,"\n\n")
os.system(cmd1)

cmd2='python3 '+ GLOBAL_PATH + '/lib/DLS2F_evaluate_SCOP.py  '+ test_datafile  + '  '+GLOBAL_PATH +'/datasets/D1_SimilarityReduction_dataset/fold_label_relation2.txt  '  + resultdir + '  ' + results_test
print("Running ", cmd2,"\n\n")
os.system(cmd2)
...
cmd1='python3 '+ GLOBAL_PATH + '/lib/DLS2F_predict_fea.py  '+ val_datafile + '  ' + modelfile+ '  ' + weightfile+ '  ' + feature_dir_global + '  ' +  pssm_dir_global + ' '   + resultdir + '   '+str(ktop_node)
print("Running ", cmd1,"\n\n")
os.system(cmd1)

cmd2='python3 '+ GLOBAL_PATH + '/lib/DLS2F_evaluate_SCOP.py  '+ val_datafile  + '  '+GLOBAL_PATH +'/datasets/D1_SimilarityReduction_dataset/fold_label_relation2.txt '  + resultdir + '  ' + results_val
print("Running ", cmd2,"\n\n")
os.system(cmd2)
